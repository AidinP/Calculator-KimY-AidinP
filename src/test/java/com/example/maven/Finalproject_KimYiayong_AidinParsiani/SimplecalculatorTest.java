...
public class SimplecalculatorTest {
	...
	public void testAdditionPositiveNumbers() {
		...
		for (int i = 0; i < 50; i++) {
			...
			LOG.info("Testing the method Positive addition with numbers: " + df.format(firstNumber) + " and "
	...
	public void testAdditionNegativeNumbers() {
		...
		for (int i = 0; i <= 50; i++) {
			...
			LOG.info("Testing method Negative addition with numbers: " + df.format(firstNumber) + " and "
	...
	public void testAdditionZeroNumbers() {
		...
		for (int i = 0; i <= 50; i++) {
			...
			LOG.info("Testing method Zero addition with numbers: " + df.format(firstNumber) + " and "
					+ df.format(secondNumber));
			assertEquals(sc.addition(firstNumber, secondNumber), result, 0);
	...
	public void testSubstractionPositiveNumbers() {
		...
		for (int i = 0; i <= 50; i++) {
			...
			secondNumber = random.nextDouble() * 10;
			result = firstNumber - secondNumber;
			LOG.info("Testing method Positive substraction with numbers: " + df.format(firstNumber) + " and "
					+ df.format(secondNumber));
